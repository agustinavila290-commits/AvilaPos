...
export default function Layout() {
  ...
  const ocultarWa = RUTAS_SIN_WA.some(r => pathname.startsWith(r))
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* WhatsApp flotante con efecto pulse */}
      {!ocultarWa && (
        <a
        ...
        >
          {/* Anillo de pulse */}
          <span className="wa-ring absolute inset-0 rounded-full" />
          {/* Botón principal */}
          <span className="relative flex items-center justify-center w-14 h-14 rounded-full
                           bg-avila-green shadow-xl
                           group-hover:bg-green-600 group-hover:scale-110
