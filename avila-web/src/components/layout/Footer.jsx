  ...
  return (
    <footer className="bg-brand-dark text-white mt-16">
      <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <p className="font-bold text-lg mb-1 text-white">{SITIO.nombre}</p>
          <p className="text-gray-400 text-sm mb-1">{SITIO.direccion}</p>
          <p className="text-gray-400 text-sm mb-3">{SITIO.localidad}, {SITIO.provincia}</p>
          <a
        ...
        <div>
          <p className="font-semibold mb-3 text-white">Navegación</p>
        ...
        <div>
          <p className="font-semibold mb-3 text-white">Medios de pago</p>
          <ul className="space-y-2 text-sm text-gray-400">
            <li className="flex items-center gap-2">
              <span className="text-brand-blue">●</span> Mercado Pago
            </li>
            <li className="flex items-center gap-2">
              <span className="text-brand-blue">●</span> Transferencia bancaria
            </li>
            <li className="flex items-center gap-2">
              <span className="text-brand-blue">●</span> Efectivo al retirar
            </li>
          </ul>
          <p className="text-gray-500 text-xs mt-4">
            Retiro en local<br />Envíos a todo el país
          </p>
        </div>
      </div>
