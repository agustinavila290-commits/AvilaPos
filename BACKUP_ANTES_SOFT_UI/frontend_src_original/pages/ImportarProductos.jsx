    ...
    <div>
      ...
      <div className="card bg-blue-50 border border-blue-200 mb-6">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-blue-800">
          ...
          <li><strong>Columnas requeridas:</strong> codigo, nombre_producto, nombre_variante, marca, categoria, costo, precio_mostrador, precio_web</li>
          <li>Columnas opcionales: stock_inicial</li>
