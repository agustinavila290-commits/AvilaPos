    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-900">{producto.nombre_completo}</h1>
          <p className="text-gray-600 mt-1">Código: {producto.codigo}</p>
        </div>
            ...
            <div className="card">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-gray-900">${parseFloat(producto.costo).toFixed(2)}</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <p className="text-sm text-blue-600 mb-1">Precio Mostrador</p>
                  <p className="text-2xl font-bold text-blue-900">${parseFloat(producto.precio_mostrador).toFixed(2)}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <p className="text-sm text-purple-600 mb-1">Precio Web</p>
                  <p className="text-2xl font-bold text-purple-900">${parseFloat(producto.precio_web).toFixed(2)}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <p className="text-sm text-green-600 mb-1">Precio Tarjeta</p>
                  <p className="text-2xl font-bold text-green-900">${parseFloat(producto.precio_tarjeta).toFixed(2)}</p>
                </div>
              </div>
