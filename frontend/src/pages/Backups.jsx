...
export default function Backups() {
  ...
  return (
    <div className="space-y-3 sm:space-y-4 lg:space-y-6">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-3 lg:gap-4">
        <div>
        ...
        <button
          ...
          className="px-3 py-2 sm:px-4 sm:py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg sm:rounded-xl transition-colors disabled:bg-gray-400 font-semibold text-sm sm:text-base whitespace-nowrap"
        >
      ...
      {estadisticas && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 border border-gray-100">
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">{estadisticas.total_backups}</p>
          </div>
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 border border-gray-100">
            <p className="text-xs sm:text-sm text-gray-600">Tamaño Total</p>
            <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-600">{estadisticas.tamanio_total_mb} MB</p>
          </div>
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 border border-gray-100">
            <p className="text-xs sm:text-sm text-gray-600">Exitosos</p>
            <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-600">{estadisticas.backups_exitosos}</p>
          </div>
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 border border-gray-100">
            <p className="text-xs sm:text-sm text-gray-600">Fallidos</p>
            <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-red-600">{estadisticas.backups_fallidos}</p>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden border border-gray-100">
        <div className="px-4 py-3 sm:px-6 sm:py-4 border-b border-gray-200">
          <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-800">Archivos de Backup</h2>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="hidden sm:table-cell px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase">
                  Fecha
                </th>
                <th className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase">
                  Tamaño
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden border border-gray-100">
        <div className="px-4 py-3 sm:px-6 sm:py-4 border-b border-gray-200">
          <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-800">Historial de Backups</h2>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="hidden md:table-cell px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase">
                  Usuario
                </th>
              </tr>
            </thead>
                ...
                logs.map((log) => (
                  <tr key={log.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-flex px-2 py-1 sm:px-3 sm:py-1 text-xs sm:text-sm font-semibold rounded-lg ${
                        log.estado === 'EXITOSO'
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-200">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-red-600">⚠️ Confirmar Restauración</h3>
            </div>
            ...
            <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-t border-gray-200 flex justify-end gap-2 sm:gap-3">
              <button
                onClick={() => {
                  setMostrarConfirmacion(false);
                  setArchivoARestaurar(null);
                }}
                className="px-3 py-2 sm:px-4 sm:py-2.5 bg-gray-200 text-gray-700 rounded-lg sm:rounded-xl hover:bg-gray-300 text-sm sm:text-base"
              >
                Cancelar
              </button>
              <button
