  ...
  return (
    <div className="space-y-3 sm:space-y-4 lg:space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-3 lg:gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">Devoluciones</h1>
          <p className="text-sm sm:text-base text-gray-600 mt-1">Gestión de devoluciones de ventas</p>
        </div>
        <Link
          to="/devoluciones/nueva"
          className="px-3 py-2 sm:px-4 sm:py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg sm:rounded-xl transition-colors text-sm sm:text-base font-semibold"
        >
          Nueva Devolución
        </Link>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-200 rounded-lg sm:rounded-xl text-sm sm:text-base"
            >
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {devoluciones.map((devolucion) => (
                    <tr key={devolucion.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-900 truncate min-w-0">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 sm:px-3 sm:py-1 text-xs sm:text-sm rounded-lg ${getEstadoBadge(devolucion.estado)}`}>
